...
@section('title', 'Добавить статью на казахском')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Добавить страницу kz</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('postkz.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="htmlcode" class="html-code" style="width: 100%; height: 250px;"></textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
