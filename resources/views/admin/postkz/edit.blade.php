...
@section('title', 'Редактировать статью на казахском')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактировать страницу: {{ $post['title'] }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('postkz.update', $post['id']) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="feature_image">Баннер страницы</label>
                                ...
                                <div class="form-group">
                                    <label>HTML код</label><br>
                                    <textarea name="htmlcode" class="html-code border" style="width: 100%; height: 250px;">{{ $post['htmlcode'] }}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
